    ...
    def admin_thumbnail(self):
        if self.photo:
            try:
                ...
                return u'<a href="%s.s3.amazonaws.com" target="_blank"><img src="%s%s"></a>' % (self.photo.url, self.photo.storage.base_url, cbim)
            except IOError:
                return u'&nbsp;'
    ...
    def admin_thumbnail_two(self):
        if self.photo_two:
            try:
                ...
                return u'<a href="%s.s3.amazonaws.com" target="_blank"><img src="%s%s"></a>' % (self.photo_two.url, self.photo_two.storage.base_url, cbim)
            except IOError:
                return u'&nbsp;'
        else:
